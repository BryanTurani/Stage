...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44322/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44322/Checkout/CheckoutCancel.aspx";
        ...
        using (Stage.Logic.ShoppingCartActions myCartOrders = new Stage.Logic.ShoppingCartActions())
        {
